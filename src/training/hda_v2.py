"""HDAv2: align CICIDS and UNSW at the 256D hidden interface."""
...
def train_hda_v2(source_model, source_loader, target_loader, target_dim, epochs, lr):
    return train_shared_hda(
        source_model, source_loader, target_loader, target_dim,
        epochs=epochs, lr=lr, alignment_space="hidden",
    )
